...
import com.sung.demo.restapi.domain.CurrentUser;
import com.sung.demo.restapi.domain.Event;
import com.sung.demo.restapi.domain.dto.EventDto;
import com.sung.demo.restapi.domain.validator.EventValidator;
...
public class EventController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<?> putEvent(@PathVariable Integer id, @RequestBody @Valid EventDto eventDto,
